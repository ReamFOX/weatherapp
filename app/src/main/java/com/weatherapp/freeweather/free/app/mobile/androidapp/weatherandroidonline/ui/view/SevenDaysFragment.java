...
public class SevenDaysFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.loadWeather(viewModel.getCurrentCity().getValue()).observe(getViewLifecycleOwner(), weatherData -> {
            if (weatherData != null) {
                binding.sevenDaysForecast.removeAllViews();
                ...
                for (DayData day : days) {
                    if (daysCounter == 7) {
                        ...
                        binding.sevenDaysForecast.addView(card);
                        daysCounter++;
                    }
                }
            }
    ...
    public View formDayleCard(LayoutInflater inflater, DayData day, boolean isToday) {
        View dayleCard = inflater.inflate(R.layout.item_daily_forecast, binding.sevenDaysForecast, false);
